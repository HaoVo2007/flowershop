...
session_start();
    ...
    $selectProductQuery = "SELECT * FROM `product`";
    $ProductCount = 0; 
    ...
    if (isset($_POST['search'])) {
        ...
        if (!empty($searchKey)) {
            $selectProductQuery .= " WHERE `name` LIKE '%$searchKey%'";
...
<body>
    ...
    <section class="popular-brands">
        ...
        <h3 class="search-content"><?php echo $ProductCount ?> result for <?php echo $searchKey?></h3>
        <div class="popular-brands-content">
            <div class="container-fluid bg-trasparent my-4 p-3" style="position: relative">
                <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3">
                    <?php
                        $selectProductResult = mysqli_query($conn, $selectProductQuery) or die ("Query Failed: " . mysqli_error($conn));
